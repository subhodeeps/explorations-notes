...
module.exports = {
  ...
  siteMetadata: {
    ...
    title: `Learning | Subhodeep`, // Replace it with your site's title
    author: `subhodeeps`, // Replace it with your name
    description: `personal notes and references`, // Replace it with your site's description
  },
  plugins: [
    {
